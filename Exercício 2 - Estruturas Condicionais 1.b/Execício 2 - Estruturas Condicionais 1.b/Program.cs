...
namespace Execício_2___Estruturas_Condicionais
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (N1 > N2 & N1 > N3)
            {
                Console.WriteLine("O primeiro número seu, é o maior deles.");
            }
            else if (N2 > N1 & N2 > N3)
            {
                Console.WriteLine(" O segundo número seu, é o maior deles.");
            }
            else if (N3 > N1 & N3 > N2)
            {
                Console.WriteLine(" O terceiro número seu, é o maior deles.");
            }
